	...
	case TYPE_CFUNC:
		{
			...
			if( arity == CFUNC_ARITY_RAW ) {
				...
				switch( arg_num ) {
				case 0:
					*result = ((CFunction0)func->func)( ctx );
					break;
				case 1:
					*result = ((CFunction1)func->func)( ctx, v[0] );
					break;
				case 2:
					*result = ((CFunction2)func->func)( ctx, v[0], v[1] );
					break;
				case 3:
					*result = ((CFunction3)func->func)( ctx, v[0], v[1], v[2] );
					break;
				case 4:
					*result = ((CFunction4)func->func)( ctx, v[0], v[1], v[2], v[3] );
					break;
				case 5:
					*result = ((CFunction5)func->func)( ctx, v[0], v[1], v[2], v[3], v[4] );
					break;
				case 6:
					*result = ((CFunction6)func->func)( ctx, v[0], v[1], v[2], v[3], v[4], v[5] );
					break;
				case 7:
					*result = ((CFunction7)func->func)( ctx, v[0], v[1], v[2], v[3], v[4], v[5], v[6] );
					break;
				default:
					assert(0);
				}
